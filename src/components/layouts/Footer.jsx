      ...
      <div className="w-11/12 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 border-b border-neutral-content/10 pb-12">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-white tracking-tight">Kidz Zone.</h2>
            <p className="text-neutral-content/60 leading-relaxed text-sm">
              Premium quality for your little ones. We believe in comfort, style, and sustainability for the future generation.
            </p>
            <div className="flex gap-4">
              <a href="#" className="text-neutral-content/60 hover:text-white transition-colors"><FaFacebook size={20} /></a>
              <a href="#" className="text-neutral-content/60 hover:text-white transition-colors"><FaInstagram size={20} /></a>
              <a href="#" className="text-neutral-content/60 hover:text-white transition-colors"><FaTwitter size={20} /></a>
              <a href="#" className="text-neutral-content/60 hover:text-white transition-colors"><FaYoutube size={20} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-neutral-content/60">
              <li className="flex items-start gap-3">
                ...
                <span>123 Kids Street, Dhaka,<br />Bangladesh</span>
              </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-neutral-content/40">
          <p>&copy; {new Date().getFullYear()} Kidz Zone. All rights reserved.</p>
